...
```
![alt text](_posts/images/image-1.png)
 ## 공분산과 상관성 분석
 **공분산: 서로 공유하는 분산**
 ...
 * 계산식
 ![alt text](_posts/images/mage-2.png)
 * 한계$  
...
* 공식
![alt text](_posts/images/image-3.png)
* 해석표  
    ...
    ![alt text](_posts/images/image-4.png)
* 결정계수 : 상관계수의 제곱
...
* 방사형 차트
    * 하나의 차트에 하나의 그룹 시각화
    ![alt text](_posts/images/image-5.png)
    * 하나의 차트에 모든 그룹 한 번에 시각화
    ![](_posts/images/image-6.png)
* 평행 좌표 그래프를 통한 그룹별 요소 비교 시각화
    * ![alt text](_posts/images/image-7.png)
...
* 두 개의 변수 간 관게만 표현 가능   
    * 버블차트 이용
    * ![alt text](_posts/images/image-10.png)
...
* 최솟값 최댓값 범위 넘어가는 값은 이상치로서 작은 원으로 표시
    * ![alt text](_posts/images/image-16.png)
* 분위수 수식
    * ![alt text](_posts/images/image-17.png)
* 박스 플롯과 정규분포의 관계
    * ![alt text](_posts/images/image-18.png)